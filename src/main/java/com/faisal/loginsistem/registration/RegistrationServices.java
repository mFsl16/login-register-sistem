...
import com.faisal.loginsistem.email.EmailSender;
...
public class RegistrationServices {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appUserServices.signUpUser(
                new AppUser(
        ...
        emailSender.sendEmail(request.getEmail(), buildEmail(request.getLastName(), link ));
